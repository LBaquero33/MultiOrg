...
alter table public.sd_customer_accounts enable row level security;
alter table public.sd_customer_account_players enable row level security;
alter table public.sd_invoice_installments enable row level security;
alter table public.sd_payment_applications enable row level security;
alter table public.sd_account_credits enable row level security;
alter table public.sd_financial_reminder_policies enable row level security;
alter table public.sd_financial_notification_intents enable row level security;
alter table public.sd_financial_audit_logs enable row level security;
