...
alter table public.sd_metric_definitions enable row level security;
alter table public.sd_report_runs enable row level security;
revoke all on table public.sd_metric_definitions,public.sd_report_runs from public,anon,authenticated;
grant select on table public.sd_metric_definitions to authenticated;
grant select on table public.sd_report_runs to authenticated;
