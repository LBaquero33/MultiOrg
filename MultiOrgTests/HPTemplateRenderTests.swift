...
final class HPTemplateRenderTests: XCTestCase {
  ...
  func testRenderTemplatesIPhone() throws {
    try renderAll(name: "iphone", width: 393, dts: .large, isWide: false)
  }

  func testRenderTemplatesIPhoneAX3() throws {
    try renderAll(name: "iphone-ax3", width: 393, dts: .accessibility3, isWide: false)
  }

  func testRenderTemplatesIPad() throws {
    try renderAll(name: "ipad", width: 834, dts: .large, isWide: true)
  }

  func testRenderTemplatesMac() throws {
    try renderAll(name: "macos", width: 1200, dts: .large, isWide: true)
  }
  ...
  private func renderAll(name: String, width: CGFloat, dts: DynamicTypeSize, isWide: Bool) throws {
  ...
  #else
  func testRenderTemplatesIPhone() throws { throw XCTSkip("UIKit required") }
  #endif
}
