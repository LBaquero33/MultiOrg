          ...
          HPCard {
            VStack(alignment: .leading, spacing: HP.Space.sm) {
              ...
              HPButton(title: "Refresh now", systemImage: "arrow.clockwise",
                       variant: .secondary, size: .sm, fullWidth: dts.isAccessibilitySize)
            }
          }
        case .configError:
          HPCard {
  ...
  private var paywall: some View {
    HPCard {
      VStack(alignment: .leading, spacing: HP.Space.md) {
        ...
        HPButton(title: "Subscribe", variant: .primary, size: .lg, fullWidth: true)
        HPButton(title: "Restore purchases", variant: .tertiary, size: .sm, fullWidth: true)
